...
//classes loading begin
    ...
    if(isset($_SESSION['user'])){
		...
		$rdv = $rendezVousManager->getRendezVousById($idRdv);
				...
				<div class="tab-pane active" id="tab_1">
                           <div class="portlet box blue">
                              ...
                              <div class="portlet-body form">
                                 <!-- BEGIN FORM-->
                                 <?php if(isset($_SESSION['rendez-vous-success'])){ ?>
                                 	<div class="alert alert-success">
    									<button class="close" data-dismiss="alert"></button>
    									<?= $_SESSION['rendez-vous-success'] ?>		
    								</div>
                                 <?php } 
                                 	unset($_SESSION['rendez-vous-success']);
                                 ?>
                                 <?php if(isset($_SESSION['rendez-vous-error'])){ ?>
                                 	<div class="alert alert-error">
    									<button class="close" data-dismiss="alert"></button>
    									<?= $_SESSION['rendez-vous-error'] ?>		
    								</div>
                                 <?php } 
                                 	unset($_SESSION['rendez-vous-error']);
                                 ?>
                                 <form action="controller/UpdateRendezVousController.php" method="POST" class="horizontal-form">
                                    <div class="row-fluid">
                                       <div class="span4 ">
                                          <div class="control-group autocomplet_container">
                                             ...
                                             <div class="controls">
                                                <input type="text" id="client_id" name="client" class="m-wrap span12" value="<?= $rdv->nomClient() ?>" onkeyup="autocomplet()">
                                       ...
                                       <div class="span4 ">
                                          <div class="control-group">
                                             ...
                                             <div class="controls">
                                                <input type="text" id="cin" name="cin" class="m-wrap span12" value="<?= $rdv->cin() ?>">
                                             </div>
                                          </div>
                                       </div>
                                       <div class="span4 ">
                                          <div class="control-group">
                                             ...
                                             <div class="controls">
                                                <input type="text" id="numeroTelefon1" name="numeroTelefon1" class="m-wrap span12" value="<?= $rdv->telefonClient() ?>">
                                             </div>
                                          </div>
                                       </div>
                                    </div>
                                    <div class="row-fluid">
                                          ...
                                          <div class="control-group">
                                             ...
                                             <div class="controls">
                                                <input type="text" id="mandataire" name="mandataire" class="m-wrap span12" value="<?= $rdv->mandataire() ?>">
                                             </div>
                                          </div>
                                       </div>
                                       <div class="span4 ">
                                          <div class="control-group autocomplet_container">
                                             ...
                                             <div class="controls">
                                                <input type="text" id="source_id" name="source" class="m-wrap span12" onkeyup="autocomplet_source()" value="<?= $rdv->source() ?>">
                                       ...
                                       <div class="span4 ">
                                          <div class="control-group">
                                             ...
                                             <div class="controls">
                                                <input type="text" id="numeroTelefon2" name="numeroTelefon2" class="m-wrap span12" value="<?= $rdv->telefonSource() ?>">
                                             </div>
                                          </div>
                                       </div>
                                    </div>
                                          ...
                                          <div class="control-group">
                                             ...
                                             <div class="controls">
                                                <div class="input-append date date-picker" data-date="" data-date-format="yyyy-mm-dd">
				                                    <input name="dateSortie" class="m-wrap m-ctrl-medium date-picker" size="16" type="text" value="<?= $rdv->dateRdv() ?>" />
                                          ...
                                          <div class="control-group">
										    ...
										    <div class="controls">
			                                 <div class="input-append">
			                                    <input type="text" name="heureRdv" id="clockface_2" class="m-wrap small" readonly="" value="<?= $rdv->heureRdv() ?>" />
                                    ...
                                    <div class="row-fluid">
                                    	<div class="span3 ">
                                          <div class="control-group">
                                             ...
                                             <div class="controls">
                                                <input type="text" id="natureTravail" name="natureTravail" class="m-wrap span12" value="<?= $rdv->nature() ?>">
                                             </div>
                                          </div>
                                       </div>
                                       <div class="span3 ">
                                          <div class="control-group">
                                             ...
                                             <div class="controls">
                                                <input type="text" id="prix" name="prix" class="m-wrap span12" value="<?= $rdv->prix() ?>">
                                             </div>
                                          </div>
                                       </div>
                                       <div class="span3 ">
                                          <div class="control-group autocomplet_container">
                                             ...
                                             <div class="controls">
                                                <input type="text" id="province_id" name="province" class="m-wrap span12" value="<?= $rdv->province() ?>" onkeyup="autocomplet_province()">
                                    ...
                                    <div class="row-fluid">
                                       <div class="span3 ">
                                          <div class="control-group autocomplet_container">
                                             ...
                                             <div class="controls">
                                                <input type="text" id="municipalite_id" name="municipalite" class="m-wrap span12" value="<?= $rdv->mp() ?>" onkeyup="autocomplet_municipalite()">
                                       ...
                                       <div class="span3 ">
                                          <div class="control-group autocomplet_container">
                                             ...
                                             <div class="controls">
                                                <input type="text" id="commune_id" name="commune" class="m-wrap span12" value="<?= $rdv->cr() ?>" onkeyup="autocomplet_commune()">
                                       ...
                                       <div class="span3 ">
                                          <div class="control-group autocomplet_container">
                                             ...
                                             <div class="controls">
                                                <input type="text" id="quartier_id" name="quartier" class="m-wrap span12" value="<?= $rdv->quartier() ?>" onkeyup="autocomplet_quartier()">
                                    ...
                                    <div class="form-actions">
										<input type="hidden" id="idRdv" name="idRdv" class="m-wrap span12" value="<?= $rdv->id() ?>">
