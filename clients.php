...
//classes loading begin
    ...
    if(isset($_SESSION['user'])){
        ...
        $clientPerPage = 10;
        $clientNumber = $clientsManager->getClientNumber();
        ...
        $pagination = paginate('clients.php', '?p=', $pageNumber, $p);
			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<h3 class="page-title">
							Gestion des clients Topographe
						</h3>
						<ul class="breadcrumb">
							<li>
								<i class="icon-home"></i>
						...
						<div class="tab-pane active" id="tab_1">
                           <div class="portlet box red">
                              ...
                              <div class="portlet-body form">
                                 ...
                                 ?>
                                 <form action="controller/AddClientController.php" method="POST" class="horizontal-form">
                                    <div class="row-fluid">
                                       <div class="span4 ">
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									<tbody>
										<?php foreach ($clients as $client) {
											$deletePath = "controller/DeleteClientController.php?idClient=".$client->id();	
										?>	
										<tr class="">
											<td><?= $client->nom()?></td>
											<td><?= $client->cin()?></td>
											<td><?= $client->numeroTelefon()?></td>
											<td><a href="clients-update.php?idClient=<?= $client->id() ?>">Modifier</a></td>
											<?php //this part of process is reserved to mohamed profil 
											if($_SESSION['user']->login()=="mohamed"){
											?>
											<td>
