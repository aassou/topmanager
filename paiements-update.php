...
//classes loading begin
    ...
    if(isset($_SESSION['user'])){
    	...
    	$idPaiement=1;
		$paiement = "";
    	if(isset($_GET['idPaiements']) and ($_GET['idPaiements']>0 and $_GET['idPaiements']<= $paiementsManager->getLastId())){
    		$idPaiement = $_GET['idPaiements'];
			$paiement = $paiementsManager->getPaiementsById($idPaiement);
    	}
				...
				<div class="tab-pane active" id="tab_1">
                   <div class="portlet box blue">
                      <div class="portlet-title">
                         <h4><i class="icon-edit"></i>Modifier Paiements</h4>
                         <div class="tools">
                      ...
                      <div class="portlet-body form">
                         ...
                         ?>
                         <form action="controller/UpdatePaiementsController.php" method="POST" class="horizontal-form">
                            <div class="row-fluid">
                               <div class="span4 ">
                                  <div class="control-group">
                                     <label class="control-label" for="mois">Date Opération</label>
                                     <div class="input-append date date-picker" data-date="" data-date-format="yyyy-mm-dd">
	                                    <input name="dateOperation" class="m-wrap m-ctrl-medium date-picker" size="16" type="text" value="<?= $paiement->dateOperation() ?>" />
                               ...
                               <div class="span4 ">
                                  <div class="control-group">
                                     ...
                                     <div class="controls">
                                        <input type="text" id="montant" name="montant" class="m-wrap span12" value="<?= $paiement->montant() ?>">
                                     </div>
                                  </div>
                               </div>
                            </div>
                            <input type="hidden" name="idAffaire" class="m-wrap span12" value="<?= $paiement->idAffaire() ?>">
                            <input type="hidden" name="idPaiements" class="m-wrap span12" value="<?= $idPaiement ?>">
                            <div class="form-actions">
                               <button type="submit" class="btn black"><i class="icon-ok"></i> Modifier</button>
                               <a href="paiements.php?idAffaire=<?= $paiement->idAffaire() ?>" class="btn">Annuler</a>
                            </div>
                         </form>
                         <!-- END FORM--> 
                      </div>
