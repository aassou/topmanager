...
//classes loading begin
    ...
    if(isset($_SESSION['user'])){
    	...
    	$idClient=1;
    	if(isset($_GET['idClient']) and ($_GET['idClient']>0 and $_GET['idClient']<= $clientManager->getLastId())){
			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<h3 class="page-title">
							Modification Client Topographe
						</h3>
						<ul class="breadcrumb">
							<li>
								<i class="icon-home"></i>
				...
				<div class="tab-pane active" id="tab_1">
                           <div class="portlet box red">
                              ...
                              <div class="portlet-body form">
                                 ...
                                 ?>
                                 <form action="controller/UpdateClientController.php" method="POST" class="horizontal-form">
                                    <div class="row-fluid">
                                       <div class="span4 ">
                                    ...
                                    <div class="form-actions">
                                       ...
                                       <a href="clients.php" class="btn">Annuler</a>   
                                    </div>
                                 </form>
                                 <!-- END FORM--> 
                              </div>
