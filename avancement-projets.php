				...
				<div class="row-fluid">
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li><a>Avancement des projets</a></li>
						</ul>
					...
					<div class="span12">
                        <div class="portlet box grey">
							<div class="portlet-title">
								<h4><i class="icon-reorder"></i>Avancement des projets</h4>
								<div class="tools">
							...
							<div class="portlet-body">
								...
								<?php foreach($projets as $projet){ 
									$taches = $tacheManager->getTachesByIdProjet($projet->id());
									$tacheNumber = $tacheManager->getTacheNumberByIdProjet($projet->id());
									$checkedTacheNumber = $tacheManager->getCheckedTacheNumberByIdProjet($projet->id());
									if($tacheNumber!=0){
								...
								?>
								<a href="suivi-projet.php?idProjet=<?= $projet->id() ?>" class="btn btn-primary"><strong>Projet : <?= $projet->nom() ?></strong></a>
								<br><br> 
