...
<body class="login">
  ...
  <div class="content">
    <!-- BEGIN LOGIN FORM -->
    <form class="form-vertical login-form" action="controller/ConnectionController.php" method="POST">
      ...
      ?>			
		  <div class="alert alert-error">
	        <button class="close" data-dismiss="alert"></button>
	        <span><?php echo $_SESSION['connection_error']; ?></span>
	      </div>
      <?php
		}
      ...
      <div class="forget-password">
        ...
        <p>
          <a href="javascript:;" class="" id="forget-password">Cliquez ici</a>
          pour le récuperer.
        </p>
      </div>
    </form>
    ...
    <form class="form-vertical forget-form">
      ...
      <p>Entrez votre Email pour saisir un nouveau.</p>
      <div class="control-group">
        <div class="controls">
          <div class="input-icon left">
      ...
      <div class="form-actions">
        ...
        Confirmer <i class="m-icon-swapright m-icon-white"></i>
        </button>            
      </div>
    </form>
