				...
				<div class="tab-pane active" id="tab_1">
                           <div class="portlet box blue">
                              <div class="portlet-title">
                                 <h4><i class="icon-edit"></i>Ajouter un nouveau rendez-vous</h4>
                                 <div class="tools">
                              ...
                              <div class="portlet-body form">
                                 ...
                                 ?>
                                 <form action="controller/AddRendezVousController.php" method="POST" class="horizontal-form">
                                    <div class="row-fluid">
                                       <div class="span4 ">
                                          <div class="control-group autocomplet_container">
                                             <label class="control-label" for="client">Nom du Client</label>
                                             <div class="controls">
                                                <input type="text" id="client_id" name="client" class="m-wrap span12" placeholder="" onkeyup="autocomplet()">
                                       ...
                                       <div class="span4 ">
                                          <div class="control-group">
                                             ...
                                             <div class="controls">
                                                <input type="text" id="cin" name="cin" class="m-wrap span12" placeholder="">
                                             </div>
                                          </div>
                                       </div>
                                       <div class="span4 ">
                                          <div class="control-group">
                                             ...
                                             <div class="controls">
                                                <input type="text" id="numeroTelefon1" name="numeroTelefon1" class="m-wrap span12" placeholder="">
                                             </div>
                                          </div>
                                       </div>
                                    </div>
                                    <div class="row-fluid">
                                          ...
                                          <div class="control-group">
                                             ...
                                             <div class="controls">
                                                <input type="text" id="mandataire" name="mandataire" class="m-wrap span12" placeholder="">
                                             </div>
                                          </div>
                                       </div>
                                       <div class="span4 ">
                                          <div class="control-group autocomplet_container">
                                             ...
                                             <div class="controls">
                                                <input type="text" id="source_id" name="source" class="m-wrap span12" onkeyup="autocomplet_source()">
                                       ...
                                       <div class="span4 ">
                                          <div class="control-group">
                                             ...
                                             <div class="controls">
                                                <input type="text" id="numeroTelefon2" name="numeroTelefon2" class="m-wrap span12" placeholder="">
                                             </div>
                                          </div>
                                       </div>
                                    </div>
									  ...
									  <div class="span4 ">
                                          <div class="control-group">
                                             ...
                                             <div class="controls">
                                                <div class="input-append date date-picker" data-date="" data-date-format="yyyy-mm-dd">
				                                    <input name="dateSortie" class="m-wrap m-ctrl-medium date-picker" size="16" type="text" value="" />
                                          ...
                                          <div class="control-group">
										    ...
										    <div class="controls">
			                                 <div class="input-append">
			                                    <input type="text" name="heureRdv" id="clockface_2" class="m-wrap small" readonly="" />
                                       ...
                                       <div class="span4 ">
                                          <div class="control-group">
                                             ...
                                             <div class="controls">
                                                <input type="text" id="natureTravail" name="natureTravail" class="m-wrap span12" placeholder="">
                                             </div>
                                          </div>
                                       </div>
                                    </div>
                                    <div class="row-fluid">
										<div class="span4 ">
                                          <div class="control-group">
                                             ...
                                             <div class="controls">
                                                <input type="text" id="prix" name="prix" class="m-wrap span12" placeholder="">
                                             </div>
                                          </div>
                                       </div>
                                       <div class="span4 ">
                                          <div class="control-group autocomplet_container">
                                             ...
                                             <div class="controls">
                                                <input type="text" id="province_id" name="province" class="m-wrap span12" placeholder="" onkeyup="autocomplet_province()">
                                       ...
                                       <div class="span4 ">
                                          <div class="control-group autocomplet_container">
                                             ...
                                             <div class="controls">
                                                <input type="text" id="municipalite_id" name="municipalite" class="m-wrap span12" placeholder="" onkeyup="autocomplet_municipalite()">
									...
									<div class="row-fluid">
                                       <div class="span4 ">
                                          <div class="control-group autocomplet_container">
                                             ...
                                             <div class="controls">
                                                <input type="text" id="commune_id" name="commune" class="m-wrap span12" placeholder="" onkeyup="autocomplet_commune()">
                                       ...
                                       <div class="span4 ">
                                          <div class="control-group autocomplet_container">
                                             ...
                                             <div class="controls">
                                                <input type="text" id="quartier_id" name="quartier" class="m-wrap span12" placeholder="" onkeyup="autocomplet_quartier()">
