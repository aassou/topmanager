						...
						<div class="tab-pane active" id="tab_1">
                           <div class="portlet box blue">
                              ...
                              <div class="portlet-body form">
                                 ...
                                 ?>
                                 <form action="controller/AddUserController.php" method="POST" class="horizontal-form">
                                    <div class="row-fluid">
                                       <div class="span3 ">
                                          <div class="control-group">
                                             <label class="control-label" for="login">Login</label>
                                             <div class="controls">
                                                <input type="text" id="login" name="login" class="m-wrap span12" placeholder="">
                                             </div>
                                          </div>
                                       </div>
                                       <!--/span-->
                                       <div class="span3 ">
                                          <div class="control-group">
                                             ...
                                             <div class="controls">
                                                <input type="password" id="password" name="password" class="m-wrap span12" placeholder="">
                                             </div>
                                          </div>
                                       </div>
                                       <div class="span3 ">
                                          <div class="control-group">
                                             ...
                                             <div class="controls">
                                                <input type="password" id="password2" name="password2" class="m-wrap span12" placeholder="">
                                             </div>
                                          </div>
                                       </div>
                                       <div class="span3 ">
                                          <div class="control-group">
                                             <label class="control-label" for="profil">Role</label>
                                             <div class="controls">
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									<tbody>
										...
										<tr class="">
											...
											<td><a class="delete" href="#">Modifier</a></td>
