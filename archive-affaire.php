                                    ...
                                    <div class="row-fluid">
                                      ...
                                      <fieldset><legend>Infos Source</legend>
                                          ...
                                          <div class="control-group autocomplet_container">
                                             ...
                                             <div class="controls">
                                                <input type="text" id="source_id" name="source" class="m-wrap span12" value="<?= $nomSource ?>">
                                          ...
                                          <div class="control-group">
										    ...
										    <div class="controls">
			                                 <div class="input-append">
			                                    <input type="text" name="heureRdv" id="clockface_2" class="m-wrap small"  readonly="" value="<?= $affaire->heureRdv() ?>" />
                                       ...
                                       ?>
                                        <div class="span3 ">
                                          <div class="control-group">
                                             ...
                                             <div class="controls">
                                                <input type="checkbox" <?= $checked ?> id="archiver" name="archiver" class="checkbox archiver_affaire" onchange="valueChanged()">
                                             </div>
                                          </div>
                                       </div>
