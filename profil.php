						...
						<div class="tab-pane active" id="tab_1">
                           <div class="portlet box blue">
                              <div class="portlet-title">
                                 <h4><i class="icon-edit"></i>Informations du profil</h4>
                                 <div class="tools">
                                    ...
                                    <div class="row-fluid">
                                       <div class="span3 ">
                                          <div class="control-group">
                                             ...
                                             <div class="controls">
                                                <input disabled="disabled" type="text" id="login" name="login" class="m-wrap span12" value="<?= $_SESSION['user']->login() ?>">
                                             </div>
                                          </div>
                                       </div>
                                       <div class="span3 ">
                                          <div class="control-group">
                                             ...
                                             <div class="controls">
                                                <input disabled="disabled" type="text" id="profil" name="profil" class="m-wrap span12" value="<?= $_SESSION['user']->profil() ?>">
                                             </div>
                                          </div>
                                       </div>
                                       <!--/span-->
                                       ...
                                       <div class="span3 ">
                                          <div class="control-group">
                                             ...
                                             <div class="controls">
                                                <input disabled="disabled" type="text" id="dateCreation" name="dateCreation" class="m-wrap span12" value="<?= date('Y-m-d', strtotime($_SESSION['user']->created())) ?>">
                                             </div>
                                          </div>
                                       </div>
                                    </div>
                                    <div class="form-actions">
                                       <a href="#updatePassword" data-toggle="modal" class="btn red">Modifier votre mot de passe</a>
                                    </div>
                                 </form>
                                 <!-- END FORM--> 
                                 <!-- update password box begin-->
									<div id="updatePassword" class="modal hide fade in" tabindex="-1" role="dialog" aria-labelledby="login" aria-hidden="false" >
										...
										<div class="modal-body">
											<form class="form-horizontal loginFrm" action="controller/UpdatePasswordController.php" method="post">
