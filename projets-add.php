				...
				<div class="tab-pane active" id="tab_1">
                           <div class="portlet box green">
                              ...
                              <div class="portlet-body form">
                                 ...
                                 ?>
                                 <form action="controller/AddProjetController.php" method="POST" class="horizontal-form" enctype="multipart/form-data">
                                 	<div class="row-fluid">
                                      <fieldset><legend>Infos Client</legend>
                                       <div class="span3 ">
                                             ...
                                             <div class="controls">
                                                <input type="text" id="client_id" name="client" class="m-wrap span12" onkeyup="autocomplet_client()">
                                      ...
                                      <fieldset><legend>Infos Projet</legend>
                                          ...
                                          <div class="control-group">
                                             ...
                                             <div class="controls">
                                                <input type="text" name="nomProjet" class="m-wrap span12">
                                             </div>
                                          </div>
                                       </div>
                                       <div class="span3 ">
                                          <div class="control-group autocomplet_container">
                                             ...
                                             <div class="controls">
                                                <input type="text" id="type" name="type" class="m-wrap span12" onkeyup="autocomplet_type()">
                                                <ul id="type_list"></ul>
                                             </div>
                                          </div>
                                       </div>
                                       <div class="span3 ">
                                          <div class="control-group autocomplet_container">
                                             ...
                                             <div class="controls">
                                                <input type="text" id="objet" name="objet" class="m-wrap span12" onkeyup="autocomplet_objet()">
                                                <ul id="objet_list"></ul>
                                             </div>
                                          </div>
                                       </div>  
                                       ...
                                       <fieldset><legend> </legend>
                                    	<div class="span3 ">
                                          <div class="control-group autocomplet_container">
                                             ...
                                             <div class="controls">
                                                <input type="text" id="architecte" name="architecte" class="m-wrap span12" onkeyup="autocomplet_architecte()">
                                       ...
                                       <div class="span3 ">
                                          <div class="control-group">
                                             ...
                                             <div class="controls">
                                                <input type="text" name="leve" class="m-wrap span12">
                                             </div>
                                          </div>
                                       </div>
                                       <div class="span3 ">
                                       ...
                                       <div class="span3 ">
                                          <div class="control-group autocomplet_container">
                                             ...
                                             <div class="controls">
                                                <input type="text" id="ilot" name="ilot" class="m-wrap span12" onkeyup="autocomplet_ilot()">
                                                <ul id="ilot_list"></ul>
                                             </div>
                                          </div>
                                       </div>
                                       <div class="span3 ">
                                          <div class="control-group autocomplet_container">
                                             ...
                                             <div class="controls">
                                                <input type="text" id="lot" name="lot" class="m-wrap span12"  onkeyup="autocomplet_lot()">
                                                <ul id="lot_list"></ul>
                                             </div>
                                          </div>
                                       </div>
                                      ...
                                      <div class="row-fluid">
                                          ...
                                          <div class="control-group">
                                             ...
                                             <div class="controls">
                                                <div class="input-append date date-picker" data-date="" data-date-format="yyyy-mm-dd">
				                                    <input name="dateCreation" id="dateCreation" class="m-wrap m-ctrl-small date-picker" type="text" />
                                       ...
                                       <div class="span3 ">
                                          <div class="control-group">
                                             ...
                                             <div class="controls">
                                                <div class="input-append date date-picker" data-date="" data-date-format="yyyy-mm-dd">
				                                    <input name="dateFin" class="m-wrap m-ctrl-small date-picker" type="text" />
				                                    <span class="add-on"><i class="icon-calendar"></i></span>
				                                 </div>
                                             </div>
                                          </div>
                                    ...
                                    <div class="form-actions">
                                    	...
                                    	<input type="hidden" id="idArchitecte" name="idArchitecte" class="m-wrap span12">
                                       <button type="submit" class="btn black"><i class="icon-ok"></i> Ajouter</button>
                                       <input type="reset" id="idSousQuartier" name="idSousQuartier" class="btn" value="Annuler">
                                    </div>
                                 </form>
                                 <!-- END FORM--> 
                              </div>
